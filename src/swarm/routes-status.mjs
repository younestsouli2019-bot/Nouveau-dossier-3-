...
export function getRoutesStatus() {
	...
	const paypalMeApproved =
		val("PPP2_APPROVED") === "true" || val("PAYPAL_PPP2_APPROVED") === "true";
	const paypalMeSendEnabled =
...
export function writeRoutesStatus(
	filePath = "data/notifications/routes-status.json",
) {
