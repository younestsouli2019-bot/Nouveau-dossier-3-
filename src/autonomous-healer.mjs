        ...
        this.strategies = [
            {
                ...
                action: async (match) => {
                    ...
                    if (!missingPath.includes('scripts') && !missingPath.includes('src')) return false;
                    
                    console.log(`[SelfHealer] Detected missing module: ${missingPath}. Attempting stub creation...`);
            ...
            },
            {
                ...
                action: async (match) => {
                    ...
                    console.warn(`[SelfHealer] CRITICAL: Method '${methodName}' is missing. Manual intervention or advanced codegen required.`);
