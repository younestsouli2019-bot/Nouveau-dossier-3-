...
const rails = [
  ...
  },
  {
    ...
    canSendPayouts: false,
    fundsMoved: false,
    details: 'API key returns -2015 on ALL endpoints (not just IP-blocked). Key is invalid/revoked. New key being generated by operator.',
    lastProbe: new Date().toISOString(),
    fix: 'Operator generating new API key with no IP whitelist + Enable Withdrawals + Enable Spot & Margin Trading. Update .env with new key.',
