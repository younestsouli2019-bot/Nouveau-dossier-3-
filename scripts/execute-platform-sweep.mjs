...
const SOURCE_WALLETS = [
	{ id: "binance_main", type: "crypto", balance: 15000.0, currency: "USDT" },
	{ id: "kraken_reserves", type: "crypto", balance: 8500.0, currency: "USDT" },
	{ id: "paypal_ops", type: "fiat", balance: 4200.0, currency: "USD" },
];
...
async function executePlatformSweep() {
	...
	const receiptPath = path.resolve(
		"settlements/sweeps/platform_sweep_receipt.json",
	);
	...
	console.log(
		`💰 Total Value Transferred: ~$${totalSwept.toFixed(2)} (Mixed Currencies)`,
	);
