...
try {
    ...
    console.log(`Found ${manifests.length} manifests for ${prqLinks.length} PRQ links.`);
    ...
    console.log("Successfully attached PRQ links to historical settlement batches.");
