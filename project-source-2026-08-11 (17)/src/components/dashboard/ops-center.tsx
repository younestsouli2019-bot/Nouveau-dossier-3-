...
interface AutoPilotStatus {
  ...
  recentRuns: { id: string; trigger: string; phase: string; status: string; itemsAffected: number; amountAffected: number; details: string; durationMs: number; createdAt: string }[]
}
...
const phaseLabels: Record<string, { label: string; icon: typeof CircleDot }> = {
