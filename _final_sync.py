...
ignore_files = {
    ...
    '_copy_to_runner.py', '_spread_all.py', '_spread_all2.py',
    '_sync_runner.py', '_sync_from_subdir.py', '_fix_layout.py'
}
ignore_dirs = {'__pycache__', '.git', 'node_modules', 'khwarizmian_swarm'}
