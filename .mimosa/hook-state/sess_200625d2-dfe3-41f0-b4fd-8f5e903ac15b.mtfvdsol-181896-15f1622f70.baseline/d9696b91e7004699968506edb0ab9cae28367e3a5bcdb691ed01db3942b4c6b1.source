...
//   TRUTH-001: Settlement completed requires externalRef + proof
//   TRUTH-002: Settlement completed blocks internal_ledger_only
//   TRUTH-003: Revenue verified requires proofType + proofHash
//   TRUTH-004: PayoutBatch completed requires providerBatchRef
//   TRUTH-005: Procurement receipt requires deliveryProofHash
//   TRUTH-006: Generic completed status guard
// ———————————————————————————————————————————————————
...
export { installTruthGuards } from './truth-guards'
export { detectFabrication, killFabrication, withFabricationGuard } from './fabrication-killswitch'
